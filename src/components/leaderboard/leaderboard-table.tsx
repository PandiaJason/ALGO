  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-mono">
        <div className="p-4 rounded-2xl border-2 border-slate-900 bg-white shadow-[3px_3px_0px_0px_#09090b]">
          <div className="text-slate-700 text-[11px] font-bold uppercase tracking-wider flex items-center justify-between">
            ...
            <Trophy className="w-4 h-4 text-[#FBAE0C]" />
          </div>
          <div className="text-2xl font-black text-slate-950 mt-1.5 font-sans">
            {entries.length}
          </div>
        ...
        <div className="p-4 rounded-2xl border-2 border-slate-900 bg-white shadow-[3px_3px_0px_0px_#09090b]">
          <div className="text-slate-700 text-[11px] font-bold uppercase tracking-wider flex items-center justify-between">
            ...
            <Zap className="w-4 h-4 text-[#099BE9]" />
          </div>
        ...
        <div className="p-4 rounded-2xl border-2 border-slate-900 bg-white shadow-[3px_3px_0px_0px_#09090b]">
          <div className="text-slate-700 text-[11px] font-bold uppercase tracking-wider flex items-center justify-between">
            ...
            <Activity className="w-4 h-4 text-[#0AA793]" />
          </div>
          <div className="text-2xl font-black text-slate-950 mt-1.5 font-mono">
        ...
        <div className="p-4 rounded-2xl border-2 border-slate-900 bg-white shadow-[3px_3px_0px_0px_#09090b]">
          <div className="text-slate-700 text-[11px] font-bold uppercase tracking-wider flex items-center justify-between">
            ...
            <Cpu className="w-4 h-4 text-[#8647E2]" />
          </div>
          <div className="text-sm font-black text-slate-950 mt-2 font-mono">
            algo-runner:latest
          </div>
          <div className="text-[10px] text-slate-600 font-semibold mt-0.5">
            256MB RAM / 1 CPU cap
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border-2 border-slate-900 shadow-[3px_3px_0px_0px_#09090b]">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-slate-50 border-2 border-slate-900 rounded-xl text-xs font-mono text-slate-950 placeholder:text-slate-500 font-semibold focus:outline-none focus:border-[#099BE9] focus:bg-white shadow-[2px_2px_0px_0px_#09090b] transition-all"
          />
        </div>

        <div className="flex flex-wrap items-center gap-2">
          {/* Language filter */}
          <div className="inline-flex rounded-xl border-2 border-slate-900 p-1 bg-white shadow-[2px_2px_0px_0px_#09090b] text-xs font-mono overflow-x-auto">
            <button
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                selectedLanguage === "python"
                  ? "bg-[#099BE9] text-white font-bold"
                  : "text-slate-700 hover:text-slate-950 font-semibold"
              }`}
            >
              Python
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                selectedLanguage === "cpp"
                  ? "bg-[#09C899] text-white font-bold"
                  : "text-slate-700 hover:text-slate-950 font-semibold"
              }`}
            >
              C++
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                selectedLanguage === "rust"
                  ? "bg-[#FBAE0C] text-slate-950 font-bold"
                  : "text-slate-700 hover:text-slate-950 font-semibold"
              }`}
            >
              Rust
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                selectedLanguage === "go"
                  ? "bg-[#8647E2] text-white font-bold"
                  : "text-slate-700 hover:text-slate-950 font-semibold"
              }`}
            >
              Go
          ...
          <div className="flex items-center gap-1 text-xs text-slate-700 font-mono">
            <select
              ...
              className="h-9 px-3 bg-white border-2 border-slate-900 rounded-xl text-xs font-mono text-slate-950 font-bold focus:outline-none focus:border-[#099BE9] shadow-[2px_2px_0px_0px_#09090b] cursor-pointer"
            >
        ...
        <table className="w-full text-left text-xs font-sans border-collapse">
          <thead>
            <tr className="border-b-2 border-slate-900 bg-slate-100/90 text-slate-900 font-mono text-[11px] uppercase tracking-wider">
              <th className="py-3.5 px-4 w-20 text-center font-bold">Rank</th>
              <th className="py-3.5 px-4 font-bold">User</th>
              <th className="py-3.5 px-4 font-bold hidden md:table-cell">Challenge</th>
