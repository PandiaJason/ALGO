    ...
    <section className="w-full bg-white py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14 space-y-4">
          <div className="inline-flex items-center px-3.5 py-1.5 rounded-full bg-slate-50/90 border border-slate-200/90 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] hover:shadow-xs transition-all duration-300 select-none">
