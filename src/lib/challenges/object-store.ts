...
Key "b" ──┘`,
      ...
      examples: [
        {
          title: "Identical file upload",
          input: "PUT-DEDUP a test\nPUT-DEDUP b test\nSTATS-DEDUP\nexit",
          output: "PUT_OK\nPUT_OK\nPHYSICAL_CHUNKS: 1",
        },
      ],
...
Concat: "A" + "B" = "AB" ──► Committed as "file1"`,
      ...
      examples: [
        {
          title: "Sequential multipart",
          input: "init-multipart file1\nupload-part UP1 1 A\nupload-part UP1 2 B\ncomplete-multipart UP1\nGET file1\nexit",
          output: "UPLOAD_INIT\nPART_OK\nPART_OK\nCOMPLETE_OK\nAB",
        },
      ],
...
Case 2: "verify-pagecache" ──► PAGECACHE_POLLUTION: ZERO`,
      ...
      examples: [
        {
          title: "Aligned direct write",
          input: "direct-write b1 4096\nexit",
          output: "DIRECT_IO_OK",
        },
      ],
