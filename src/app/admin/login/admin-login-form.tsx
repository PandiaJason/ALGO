...
export function AdminLoginForm({ isAccessDenied = false }: AdminLoginFormProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-[#0f0f11] text-slate-100 font-sans">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/25 text-purple-300 text-xs font-mono font-semibold">
        ...
        <Card className="border-slate-800 bg-[#161619] shadow-2xl overflow-hidden relative">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="text-center text-[11px] text-slate-400">
              Only <code className="text-purple-400 font-mono">pandiajason@gmail.com</code> is authorized to access the control plane.
            </div>
          </CardContent>
        </Card>
